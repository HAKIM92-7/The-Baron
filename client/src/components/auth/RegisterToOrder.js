...
const RegisterToOrder = () => {
  ...
  const onSubmit = async (e) => {
    ...
    if (password !== password2) {
      ...
      dispatch(registerUser({ lastname, firstname, email, password }));
    }
  };
  ...
  return (
    <Fragment>
      ...
      <p className='my-1'>
        Already have an account? <Link to='/login-to-order'>Sign In</Link>
      </p>
    </Fragment>
  );
};

export default RegisterToOrder;
