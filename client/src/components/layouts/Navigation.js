...
const isAuthenticatedUser = useSelector(
  ...
  const seller = useSelector((state) => state.authSeller.seller);
    return (
        ...
        <li><Link to='/user-orders' className='link' onClick={()=>{
            dispatch(showMenu());
        ...
        <li><Link to='/dashboard' className='link' onClick={()=>{
            dispatch(showMenu());
       ...
       <li><Link to='/create-product' className='link' onClick={()=>{
        ...
        <li><Link to='/registerSeller' className='link' onClick={()=>{
            dispatch(showMenu());
            
            }}>Become a seller</Link></li>

<li><Link to='/loginSeller' className='link' onClick={()=>{
            dispatch(showMenu());
            
            }}>Login as Seller</Link></li>

<li><Link to='/login' className='link' onClick={()=>{
            dispatch(showMenu());
            
            }}>Login</Link></li>

<li><Link to='/register' className='link' onClick={()=>{
            dispatch(showMenu());
